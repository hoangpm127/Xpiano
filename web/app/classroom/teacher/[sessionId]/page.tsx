...
export default function TeacherClassroomPage() {
  ...
  const [messages, setMessages] = useState<Array<{ sender: string; text: string; time: string }>>([
    { sender: "system", text: "Chào mừng giáo viên!", time: new Date().toLocaleTimeString() },
  ]);
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-white font-semibold">
                {connectionStatus === "online" && partnerPeerId ? "👨‍🏫 Đang dạy học viên" :
        ...
        <div className="grid lg:grid-cols-3 gap-4 h-[calc(100vh-120px)]">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-gray-800 rounded-lg overflow-hidden aspect-video relative">
              ...
              {!partnerPeerId && (
                <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-500">
                  ...
                  <div className="text-lg">Đang chờ học viên tham gia...</div>
                  <div className="text-sm mt-2">Gửi link này cho học viên:</div>
              ...
              <div className="absolute bottom-4 left-4 bg-black bg-opacity-60 px-3 py-1 rounded">
                <span className="text-white font-semibold">🎓 Học viên</span>
              </div>
              {partnerPeerId && (
            ...
            <div className="bg-gray-800 rounded-lg overflow-hidden aspect-video relative">
              ...
              <div className="absolute bottom-4 left-4 bg-black bg-opacity-60 px-3 py-1 rounded">
                <span className="text-white font-semibold">👨‍🏫 Bạn (Giáo viên)</span>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-800 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-white font-semibold">Bài học hôm nay</h3>
              </div>
              <div className="text-gray-300 text-sm space-y-2">
                <div>• C Major Scale</div>
                <div>• Finger positioning</div>
                <div>• Basic rhythm</div>
              </div>
            </div>
